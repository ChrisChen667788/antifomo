...
export default async function ResearchComparePage({
  ...
  const snapshot = Array.isArray(resolved.snapshot) ? resolved.snapshot[0] : resolved.snapshot || "";
  const topicId = Array.isArray(resolved.topicId) ? resolved.topicId[0] : resolved.topicId || "";
