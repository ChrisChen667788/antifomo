...
class CollectorBrowserBatchIngestRequest(BaseModel):
...
class CollectorBrowserBatchIngestItemResponse(BaseModel):
    source_url: str
...
class CollectorBrowserBatchIngestResponse(BaseModel):
    total: int
    created: int
    deduplicated: int
    failed: int
...
class CollectorDaemonRecentRowResponse(BaseModel):
...
class CollectorDaemonStatusResponse(BaseModel):
    ...
    last_run_submit_mode: str | None = None
    last_run_discovered_count: int = 0
    last_run_collected_count: int = 0
    last_run_plugin_count: int = 0
...
class WechatAgentRouteQualityResponse(BaseModel):
    url_first_share: int = 0
    ocr_share: int = 0
    accessibility_hit_rate: int = 0
    template_hit_rate: int = 0
    route_stability: Literal["good", "watch", "poor"] = "watch"
    recommendation: str = ""
...
class WechatAgentBatchStatusResponse(BaseModel):
    ...
    duplicate_escape_count: int = 0
    route_backoff_count: int = 0
    route_circuit_breaker_count: int = 0
    recovery_action_count: int = 0
    url_only_skip_count: int = 0
    ocr_preview_seen_count: int = 0
    ocr_title_seen_count: int = 0
    accessibility_action_hits: int = 0
    template_match_hits: int = 0
    perceptual_duplicate_count: int = 0
    ...
    route_quality: WechatAgentRouteQualityResponse = Field(default_factory=WechatAgentRouteQualityResponse)
