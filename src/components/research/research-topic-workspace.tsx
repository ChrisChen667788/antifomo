...
function timelineArchiveKindLabel(
...
function timelineEventTone(eventType: ApiResearchTrackingTopicTimelineEvent["event_type"]) {
  if (eventType === "compare_snapshot") return "bg-sky-100 text-sky-700";
  if (eventType === "markdown_archive") return "bg-emerald-100 text-emerald-700";
  return "bg-slate-100 text-slate-600";
}

function buildArchiveCompareHref(
                                  ...
                                  >
                                    <div className="flex flex-wrap items-center justify-between gap-2">
                                      <a
                                        ...
                                        target="_blank"
                                        rel="noreferrer"
                                        className="font-medium text-slate-700 underline-offset-4 hover:text-sky-700 hover:underline"
                                      >
                                        {link.title}
                                      </a>
