...
export const feedItems: FeedItem[] = [
  {
    ...
    tags: ["AI", "模型评测", "推理"],
    summary:
      "官方公布了新一代推理模型在数学、代码和复杂任务上的改进，尤其在多步规划稳定性上提升明显。对开发者来说，意味着在复杂自动化场景中可减少重试和人工兜底。若你的产品强依赖复杂推理，这条值得关注。",
    shortSummary:
      "推理模型在复杂任务上稳定性明显提高，能减少多轮重试和人工兜底成本。",
    longSummary:
      "公告重点不是单一分数提升，而是多步规划时的鲁棒性和错误恢复能力。对应用层的直接影响是：复杂自动化任务失败率会下降，人工介入阈值可以后移。如果你的产品当前因为模型不稳定而保守上线，这次进展可能改变投入产出比。",
    valueScore: 92,
    suggestedAction: "立即深读",
    suggestedActionType: "deep_read",
    recommendationReasons: ["信息增量高", "与 AI 自动化主题高度相关", "来源可信度高"],
