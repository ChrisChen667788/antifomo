...
function buildResearchMeta(entry) {
  ...
  const intelligence = (entry && entry.commercial_intelligence) || payload.commercial_intelligence || null;
  ...
  return {
    ...
    methodology: intelligence && intelligence.methodology ? intelligence.methodology : null,
    confidence: intelligence && intelligence.confidence
      ? {
          ...intelligence.confidence,
          official_source_ratio_percent: Math.round(Number((intelligence.confidence && intelligence.confidence.official_source_ratio) || 0) * 100)
        }
      : null,
    coverage_gaps: intelligence && Array.isArray(intelligence.coverage_gaps) ? intelligence.coverage_gaps : [],
    account_objects: intelligence && Array.isArray(intelligence.accounts) ? intelligence.accounts.slice(0, 3) : [],
    opportunities: intelligence && Array.isArray(intelligence.opportunities) ? intelligence.opportunities.slice(0, 3) : [],
    benchmark: intelligence && intelligence.benchmark ? intelligence.benchmark : null,
    maturity: intelligence && intelligence.maturity ? intelligence.maturity : null,
