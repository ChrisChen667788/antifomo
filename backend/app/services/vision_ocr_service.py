...
class VisionOCRService:
    ...
    def _is_supported_image_payload(self, image_bytes: bytes) -> bool:
        try:
    ...
    def _resolve_openai_timeout_seconds(self) -> int:
        try:
            configured = int(self.settings.ocr_openai_timeout_seconds or self.settings.openai_timeout_seconds)
        except Exception:
            configured = int(self.settings.openai_timeout_seconds or 8)
        return max(3, min(configured, 15))
    ...
    def _extract_with_openai(
        ...
        *,
        ...
        try:
            ...
            timeout_seconds = self._resolve_openai_timeout_seconds()
