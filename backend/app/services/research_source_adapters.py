...
DEFAULT_ENABLE_CURATED_WECHAT_CHANNELS = True
...
CURATED_WECHAT_CHANNEL_LABEL = "精选公众号观察池"
...
class ResearchSourceSettings:
    ...
    enable_curated_wechat_channels: bool = DEFAULT_ENABLE_CURATED_WECHAT_CHANNELS
    ...
    def enabled_labels(self) -> list[str]:
        ...
        if self.enable_curated_wechat_channels:
            labels.append(CURATED_WECHAT_CHANNEL_LABEL)
        return labels
...
def build_research_connector_statuses(
    ...
    public_sources_active = any(
        [
            ...
            resolved.enable_curated_wechat_channels,
        ]
    )
    ...
    return [
        ...
        },
        {
            ...
            "label": CURATED_WECHAT_CHANNEL_LABEL,
            "status": "active" if resolved.enable_curated_wechat_channels else "available",
            "detail": f"优先补充公众号观察池，当前包含 {' / '.join(CURATED_WECHAT_CHANNELS)}。",
            "requires_authorization": False,
        },
    ]
...
def read_research_source_settings() -> ResearchSourceSettings:
    ...
    return ResearchSourceSettings(
        ...
        enable_curated_wechat_channels=bool(
            loaded.get("enable_curated_wechat_channels", DEFAULT_ENABLE_CURATED_WECHAT_CHANNELS)
        ),
...
def write_research_source_settings(
    *,
    ...
    payload = {
        ...
        "enable_curated_wechat_channels": bool(enable_curated_wechat_channels),
